  ...
  <table>
      ...
      <div className='flex flex-col max-w-2xl w-full mx-auto'>
        ...
        <div class="mt-3 p-3 w-full focus-within:border-blue-600">
          <textarea rows="3" class="border p-2 rounded w-full focus:outline-none" placeholder="Add comment here"></textarea>
        </div>  

        <div>
          <button class="mx-4 px-5 py-1 bg-blue-600 text-white rounded hover:shadow-md shadow-sm hover:bg-blue-500" type='submit' onClick={() => alert("You are not logged in!")}>Post</button>
        </div>
      </div>
