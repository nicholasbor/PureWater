...
const ModuleGrid = () => {
  return (
    <div className='bg-gray-200 pt-10 px-5 pb-20'>
      <h1 className='text-3xl text-black font-bold pb-8'>OUR MODULES</h1>
      ...
      <div className='flex justify-center flex-wrap pt-14'>
        <button type="button" className='btn bg-blue-400 text-white hover:bg-gray-300 hover:text-black'>CLICK HERE TO LEARN MORE</button>
      </div>
    </div>
  )
}
