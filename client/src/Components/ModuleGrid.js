...
const ModuleGrid = () => {
	return (
		<div className="bg-gray-200 pt-10 px-5 pb-20">
			<h1 style={{ fontSize: '45px' }} className="flex justify-center items-center font-Bebas text-black font-bold pb-8">
				OUR MODULES
			</h1>
			<div className="container pt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 max-w-screen-lg">
				<Link to="/modules/water-resources-and-accessibility">
				...
				<Link to="/modules/water-health-and-safety">
					<div className="bg-white p-3 rounded-md shadow-lg ease-out duration-300 hover:scale-105 hover:ease-in hover:duration-300">
				...
				<Link to="/modules/water-sustainability">
					<div className="bg-white p-3 rounded-md shadow-lg ease-out duration-300 hover:scale-105 hover:ease-in hover:duration-300">
				...
				<Link to="/modules/disinfection-and-other-hygienic-practices">
					<div className="bg-white p-3 rounded-md shadow-lg ease-out duration-300 hover:scale-105 hover:ease-in hover:duration-300">
